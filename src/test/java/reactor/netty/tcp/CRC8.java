...
public class CRC8 {
    ...
    static final byte[] crc_array_l = {0x00, (byte) 0xC0, (byte) 0xC1, (byte) 0x01, (byte) 0xC3, (byte) 0x03, (byte) 0x02,
    ...
    public static void main(String[] args) throws Exception {
        String str = "aaaaaaasadsfdsfdvfdsfdsfsdfdsfsdfsdfd";
        System.out.println("aaaa:" + getcrc(str.getBytes("UTF-8")));
        int i = 1;
        int low = i & 0xFF;
        int high = i >>> 8;
    ...
    public static int getcrc(byte[] crcdata) {
        short Crc_H = (short) 0x00FF;
        short Crc_L = (short) 0x00FF;
        short Index;
        System.out.println(crcdata.length);
        for (int i = 0; i < crcdata.length; i++) {
            Index = (short) (Crc_H ^ change(crcdata[i]));
            Crc_H = (short) (Crc_L ^ change(crc_array_h[Index]));
            Crc_L = change(crc_array_l[Index]);
            System.out.println("Crc_H:" + Crc_H + ",Crc_L:" + Crc_L);
        }
        return ((Crc_L << 8) | Crc_H) & 0X0000ffff;
    }

    public static short change(byte data) {
