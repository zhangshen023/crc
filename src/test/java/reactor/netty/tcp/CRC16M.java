...
public class CRC16M {
    ...
    public static String getCrc(String tem) {
        ...
        byte[] sbuf = CRC16M.getSendBuf(tem.getBytes());

        System.out.println("这是得到的crc" + CRC16M.getBufHexStr(sbuf));

        return CRC16M.getBufHexStr(sbuf).substring(12, 16).toLowerCase();
    ...
    public static void main(String[] args) {
        ...
        byte[] sbuf = CRC16M.getSendBuf("020400000080".getBytes());
